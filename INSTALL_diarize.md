# Diarize Installation — Windows (PowerShell)

This sets up **faster-whisper + pyannote community-1** for speaker-attributed
transcription on a Windows 11 machine with an NVIDIA GPU.

Prerequisites: PowerShell, Python 3.12, ffmpeg, NVIDIA GPU with recent drivers.
